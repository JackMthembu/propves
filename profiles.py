...
@login_required
def banking_details(banking_details_id=None):
    ...
    if form.validate_on_submit():
        ...
        # Redirect to the same page to show the popup
        return redirect(url_for('profile_routes.banking_details', success=True))
